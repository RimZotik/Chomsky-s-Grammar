      ...
      click: () => {
        dialog.showMessageBox(mainWindow, {
          ...
          detail:
            ...
            "2. Выберите 'Ввод грамматики' для определения четверки (V_T, V_N, P, S) и правил\n" +
            "3. Выберите 'Построение слов' для генерации слов по правилам грамматики\n\n" +
            "Особенности символов:\n" +
            "• ε (эпсилон) - символ пустой строки, используется для правил вида A → ε\n" +
            "• Пробел - можно использовать в терминальных символах для многосимвольных терминалов\n" +
            "• ъ - используется как специальный разделитель при необходимости\n\n" +
